<template>
  <div id="app" class="container" style="max-width: 960px;">
    ...
    <main>
      ...
      <p>Ik betaal dit project geheel uit eigen zak. Met een kleine donatie geef je niet alleen aan dat je dit project nuttig vindt, maar help je ook met de onkosten voor o.a. de domeinnamen (corona-pasje.nl en coronaboekje.nl).</p>
      <p>Kun of wil je niet doneren, ook geen probleem! Je helpt ook al door dit initiatief te promoten via bijv. mond-tot-mond reclame.</p>
    ...
    <footer class="border-top pt-3 mt-5 text-center">
      <div class="hstack gap-3 justify-content-center">
        <a href="https://buymeacoffee.com/frozenshadow" target="_blank">
          <BMCLogoMark alt="Buy Me a Coffee" class="w-100 rounded-circle" style="max-height: 40px; max-width: 40px;" />
        </a>
        <a href="https://github.com/frozenshadow/corona-pasje.nl" target="_blank">
          <GitHubLogoMark alt="GitHub" class="w-100" style="max-height: 40px; max-width: 40px;" />
        </a>
      </div>
    ...
    <modal id="createCardModal" :header="false" :footer="false">
      <button type="button" class="btn-close d-flex ms-auto" data-bs-dismiss="modal" aria-label="Sluiten"></button>
      <horizontal-stepper :steps="steps" :reset="reset" @completed-step="completeStep" @active-step="isStepActive" @stepper-finished="resetStepper()" @reset="resetStepper()"></horizontal-stepper>
    </modal>
  </div>
</template>
...
import BMCLogoMark from '@/assets/img/bmc_logo_mark.svg';
import GitHubLogoMark from '@/assets/img/github_logo_mark.svg';
import CoronaPasjeLogo from '@/assets/img/corona_pasje_logo.svg'
